const highlightWords = [
  ...
  // console.log("extracted text",paragraphs);
      ...
      for (let iter = 0; iter < highlightWords.length; iter++) {
        if (
          ...
          if (
            ...
            // correctAbbv.push(highlightWords[iter][0])
            continue;
          } else {
            temp = temp.replace(
            ...
            abbreviations.push(highlightWords[iter][0]);
          }
        }
      }
    
    
      abbvHighlightedText += temp.replace("end_of_line_00000", "") + "\n\n";
    ...
    console.log(abbv_list);

    // console.log("Added highlight", abbvHighlightedText);

    return {abbvHighlightedText, abbv_list};
  }
